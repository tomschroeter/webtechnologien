...
<body class="container">
	...
	<div class="container mt-3">
		<div class="row">
			<div>
				...
				<img src="<?php echo $correctImagePath ?>"
					alt="Image of <?php echo htmlspecialchars($artist->getFirstName() . ' ' . $artist->getLastName()) ?>">
			</div>
			<div class="col-md-8">
		...
		<h2 class="mt-5">Artworks by
			<?php echo htmlspecialchars($artist->getFirstName() . ' ' . $artist->getLastName()) ?></h2>
		<div class="row mt-4">
			<?php
