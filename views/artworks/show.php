...
<div class="mt-4">
        ...
        <div class="col-md-6">
            <a href="#" data-bs-toggle="modal" data-bs-target="#imageModal">
                <img src="<?= $correctImagePath ?>" alt="<?= htmlspecialchars($artwork->getTitle()) ?>"
                    class="img-fluid border" style="object-fit: contain; cursor: pointer; background-color: #f8f9fa;">
            </a>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            ...
            // Delete review form submit handler (delegated)
                    ...
                    fetch(form.action, {
                        ...
                        .then(data => {
                            ...
                            setTimeout(() => {
                                ...
                                // Remove "already reviewed" message if present
                                ...
                                // Show add review form again if it was hidden
                                const addReviewForm = document.getElementById('add-review-form');
                                if (addReviewForm && addReviewForm.style.display === 'none') {
                                    addReviewForm.style.display = 'block';
                                }

                                // If form does not exist, create and insert it
                                if (!addReviewForm) {
            ...
            // Accordion arrow rotation for general info
            ...
            if (generalCollapse && generalArrow) {
                generalCollapse.addEventListener('show.bs.collapse', () => generalArrow.textContent = '▲');
                generalCollapse.addEventListener('hide.bs.collapse', () => generalArrow.textContent = '▼');
            }

            // Accordion arrow rotation for location info
            ...
            if (locationCollapse && locationArrow) {
                locationCollapse.addEventListener('show.bs.collapse', () => locationArrow.textContent = '▲');
                locationCollapse.addEventListener('hide.bs.collapse', () => locationArrow.textContent = '▼');
            }
        });
    </script>