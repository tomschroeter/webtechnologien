...
<div id="homeCarousel" class="carousel slide mb-5" data-ride="carousel">
  <div class="carousel-inner">
    ...
    <div class="carousel-item active text-center p-5" style="min-height: 540px; background-color: #f8f9fa;">
      ...
      <div class="d-flex justify-content-center flex-wrap">
        ...
        ?>
          <div class="p-2">
            <img src="<?= $imagePath ?>" class="img-fluid rounded shadow-sm" style="width: 150px; height: 150px; object-fit: cover;" alt="Artwork">
          </div>
        <?php endforeach; ?>
      </div>
    </div>
  ...
  <!-- Control buttons -->
  <a class="carousel-control-prev" style="left: -70px; filter: invert(100%)" href="#homeCarousel" role="button" data-slide="prev" data-interval="2000">
    <span class="carousel-control-prev-icon" aria-hidden="true"></span>
    <span class="sr-only">Previous</span>
  </a>
  <a class="carousel-control-next" style="right: -70px; filter: invert(100%)" href="#homeCarousel" role="button" data-slide="next" data-interval="2000">
