...
<div id="homeCarousel" class="carousel slide mb-5" data-ride="carousel">
  ...
  <!-- Control buttons -->
  <a class="carousel-control-prev" style="left: -70px; filter: invert(100%)" href="#homeCarousel" role="button" data-slide="prev" data-interval="500">
    <span class="carousel-control-prev-icon" aria-hidden="true"></span>
    <span class="sr-only">Previous</span>
  </a>
  <a class="carousel-control-next" style="right: -70px; filter: invert(100%)" href="#homeCarousel" role="button" data-slide="next" data-interval="500">
